...
import de.geosphere.speechplaning.ui.sites.plan.PlanScreen
import de.geosphere.speechplaning.ui.sites.speakers.SpeakerScreen
import de.geosphere.speechplaning.ui.sites.speeches.SpeechesScreen
...
class MainActivity :
    ComponentActivity(),
    KoinComponent {
    private val vmSpeechView: SpeechViewModel by viewModel()
                        ...
                        NavHost(
                            ...
                            composable<Screen.SpeakerRoute> {
                               // NewSpeakerListComposable()
                                SpeakerScreen()
//                                 SpeakerDetailPage(navController, speakerDetailViewModel)
                            }
                            composable<Screen.SpeechesRoute> {
                                SpeechesScreen(
                                    modifier = Modifier,
                                    speechViewModel = vmSpeechView,
                                    onCheckedChange = { checked, speech ->
                                        // Todo
                                        return@SpeechesScreen true
                                    }
                                )
                            }
                        }
