    ...
    companion object {
        val speakersMockupList =
            mutableListOf<Speaker>(
                Speaker(
                    ...
                    speechNumberIds = mutableListOf("2", "23", "24"),
                ...
                Speaker(
                    ...
                    speechNumberIds = mutableListOf("31"),
                    spiritualStatus = SpiritualStatus.ELDER,
                ),
                Speaker(
                    speakerId = "5",
                ...
                Speaker(
                    ...
                    speechNumberIds = mutableListOf("11", "12", "13"),
                    spiritualStatus = SpiritualStatus.MINISTERIAL_SERVANT,
                ),
                Speaker(
                    speakerId = "8",
                ...
                Speaker(
                    ...
                    speechNumberIds = mutableListOf("21", "22", "23"),
                    spiritualStatus = SpiritualStatus.MINISTERIAL_SERVANT,
                ),
                Speaker(
                    speakerId = "13",
                ...
                Speaker(
                    ...
                    speechNumberIds = mutableListOf("40", "41"),
                    spiritualStatus = SpiritualStatus.MINISTERIAL_SERVANT,
                ),
            )
        ...
        val congregationMockupList =
            mutableListOf<Congregation>(
                Congregation(
                    congregationId = "Grafing-Süd",
                    street = "Bahnhofstrasse",
                    districtIds = "906",
                    active = true
                ),
                Congregation(
                    congregationId = "Grafing-Nord",
                    street = "Bahnhofstrasse",
                    districtIds = "906",
                    active = true
                ),
