 ...
 *
 * @property id The unique identifier for the speech. Annotated with `@DocumentId`, suggesting it's used
 *                  as the document ID in a Firestore collection. Defaults to an empty string.
 * @property number A sequential or identifying number for the speech, distinct from its document ID.
